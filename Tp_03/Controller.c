...
int controller_sortEmployee(LinkedList* pArrayListEmployee)
{
    ...
    if(pArrayListEmployee!=NULL)
    {
        ...
        case 2:
            ...
            case 1:
                printf("\nOrdenando....\n\n");
                ll_sort(pArrayListEmployee, employee_ordenarNombres,1);
                system("cls");
                controller_ListEmployee(pArrayListEmployee);
                break;
            ...
            case 2:
                printf("\nOrdenando....\n\n");
                ll_sort(pArrayListEmployee, employee_ordenarNombres,0);
                system("cls");
                controller_ListEmployee(pArrayListEmployee);
                break;
        ...
        case 4:
            ...
            case 1:
                printf("\nOrdenando....\n\n");
                ll_sort(pArrayListEmployee, employee_ordenarSueldos,1);
                system("cls");
                controller_ListEmployee(pArrayListEmployee);
                break;
            ...
            case 2:
                printf("\nOrdenando....\n\n");
                ll_sort(pArrayListEmployee, employee_ordenarSueldos,0);
